...
public class LoginActivity extends AppCompatActivity {
    ...
    private ProgressBar loginBtnLoader;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // @NOTE: Add **"pk_cf6ab9946f46b7684e8dc7d9a80c538d0c29a439"** here for SDK to be
        // authenticated with HyperTrack Server
        HyperTrack.initialize(this, "pk_test_a20e76dd350399dc693e3251e949ef5e395ca586");
    ...
    private void initUIViews() {
        ...
        loginBtnLoader = (ProgressBar) findViewById(R.id.login_btn_loader);
